...
module.config(['$routeProvider', '$locationProvider', function($routeProvider, $locationProvider) {
	...
	$routeProvider
		...
		// .when('/protect', {templateUrl: 'partials/protect.html?v=' + version, controller : App.ProtectCtrl, reloadOnSearch: false})
		// .when('/detail', {templateUrl: 'partials/detail.html?v=' + version, controller : App.DetailCtrl})
		// .when('/express', {templateUrl: 'partials/express.html?v=' + version, controller : App.ExpressCtrl, reloadOnSearch: false})
		...
		// .when('/f10', {templateUrl: 'partials/f10.html?v=' + version, controller : App.F10Ctrl})
		// .when('/video', {templateUrl: 'partials/video.html?v=' + version, controller : App.VideoCtrl})

		.when('/category',{templateUrl:'partials/audio_info.html',controller:Action.categoryList})
		// .when('/audio_comment',{templateUrl:'partials/audio_comment.html',controller:Action.commentList,reloadOnSearch:false})
		// .when('/report',{templateUrl: 'partials/report.html',controller:Action.Report,reloadOnSearch:false})
		// .when('/broadcast',{templateUrl:'partials/broadcast.html',controller:Action.broadcast})
